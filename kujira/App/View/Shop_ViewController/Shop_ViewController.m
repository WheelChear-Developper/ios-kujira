...
- (void)viewDidLoad
{
    ...
    co.latitude = 34.067629;
    co.longitude = 134.550211;
    ...
    location.latitude  = 34.067629;
    location.longitude = 134.550211;
    annotation =[[MyAnnotation alloc] initWithCoordinate:location];
    annotation.title = @"くじら両国橋店";
//    annotation.subtitle = @"";
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    UIImage *headerImage = [UIImage imageNamed:@"waku_1line.png"];
...
{
    NSURL *phone = [NSURL URLWithString:@"tel://0886567875"];
...
{
    [Configuration setWebURL:@"http://niraikanai.akafune.com/"];
}
@end
